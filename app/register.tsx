      ...
      >
        <ImageBackground source={require('@/assets/images/background.png')} resizeMode="cover" style={{flex:1,width:'100%',justifyContent:'space-around',alignItems:'center'}}>
          ...
          <View style={{alignItems:'center'}}>
            <Text style={{color:'white', fontWeight:'bold',fontSize:40}}>Register</Text>
            <Text style={{color:'white', fontWeight:'bold',fontSize:10}}>Create your account</Text>
          </View>
          ...
          <View style={{width:'90%', height:'12%', gap: 10, alignItems:'center'}}>
            ...
            <View style={{flexDirection:'row', gap: 10}}>
                ...
                <Text style={{color:'white', fontWeight:'bold',textDecorationLine:'underline'}} onPress={handlePress}>Login</Text>
            </View>
          </View>
        </ImageBackground>
      </SafeAreaView>
